...
#RUN SCRIPT AS: Rscript AncientMetagenome_Score.R RMA6_FILE_NAME OUT_DIR
...
RefID<-suppressWarnings(readLines(paste0(out_dir,"/name.list"))) #sequence ID of reference sequence that has most of reads mapped to it
